...
public class Aeroporto {
	...
	private void aviaoChegando(Aeronave aviao) {
		System.out.println(
				"Aviao solicitando aterrisagem: " + aviao.getNome() + " thread: " + Thread.currentThread().getName());
	...
	private void aviaoSaindo(Aeronave aviao) {
		System.out.println(
				"Aviao solicitando decolagem: " + aviao.getNome() + " thread: " + Thread.currentThread().getName());
		...
		if (pista.getAviao() == null && avioesPrecisandoAterrisar.isEmpty()) {
			...
			System.out.println("Pista vazia, mas com avi�o esperando para aterrisar ----  Aviao " + aviao.getNome()
	...
	private void aviaoTaxiando(Aeronave aviao) {
		System.out
				.println("Aviao Tentando taxiar: " + aviao.getNome() + " thread: " + Thread.currentThread().getName());
		...
		if (pista.getAviao() == null && avioesPrecisandoAterrisar.isEmpty() && avioesPrecisandoDecolar.isEmpty()) {
			...
			System.out.println("Pista vazia, mas com avi�o esperando para decolar ----  Aviao " + aviao.getNome()
					+ " esperando para taxiar..");
			addAviaoTaxiar(aviao);
	...
	private void aviaoEstacionado(Aeronave aviao) {
		System.out.println("Avi�o " + aviao.getNome() + " esta estacionado.");
	}

	/**
	 * Metodo que seleciona um avi�o da fila para taxiar
	 * 
	...
	/**
	 * Metodo para selecionar um avi�o da fila para decolagem
	 * 
	 * @throws InterruptedException
	 */
	...
	/**
	 * Metodo para selecionar avi�o da fila para aterrizagem
	 * 
	 * @throws InterruptedException
	 */
		...
		if (pista.getAviao() == null) {
			...
			if (!avioesPrecisandoAterrisar.isEmpty()) {
				...
				if (aviaoInicial != aviaoParaAterrisar) {
					...
					System.err.println("Taxa de 8% no valor de " + aviaoParaAterrisar.getEmpresa().getValorTaxa()
							+ " para a empresa "
